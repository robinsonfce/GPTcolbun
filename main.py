...
st.markdown("<h2 style='text-align: center;'>Chatbot Colbun: Consulta lo que desees sobre seguridad y reglamentos de Colbun</h2>", unsafe_allow_html=True)

st.markdown(
    """
    <img src="URL_A_TU_IMAGEN" width="100" align="middle">
    """,
    unsafe_allow_html=True,
)

st.markdown("<h3 style='text-align: center;'>Creado por: Robinson Cornejo</h3>", unsafe_allow_html=True)
