    ...
    with st.chat_message("assistant"):
        with st.spinner("Pensando..."):
            ...
            def refiner_answer(context, prompt, initial_answer):
                ...
                system_msg='Eres un Ingeniero Eléctrico experto en normativas y estándares eléctricos. Tu tarea es proporcionar respuestas detalladas, precisas y con referencias claras a las fuentes, sin repetir la pregunta en tus respuestas. Tus respuestas deben estar enfocadas solo a los pliegos RIC. Primero responde precisamente lo que se te pregunta y luego agregar un breve comentario. Acota tu respuesta a 80 palabras, salvo que te pidan mas detalles. Al final de la respuesta incluye las citas o referencias con la sección a revisar.'
